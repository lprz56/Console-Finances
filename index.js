...
for (var i = 0; i < finances.length; i= i+1 ) {  
...
console.log("The greatest increase in profits/losses occurred in", monthGreatestIncrease, "with a value of $:",greatestIncrease);
console.log("The greatest decrease in profits/losses occurred in", monthGreatestDecrease, "with a value of $:", - greatestDecrease);
